...
const docTemplate = `{
    ...
    "paths": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/v1.renameProjectRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.adminRenameProjectResponse"
                        }
                    },
                    "400": {
        ...
        "/api/v1/admin/projects/{id}/pipeline": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Optional pipeline stage and clean rebuild flags",
                        "name": "body",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/v1.adminPipelineTriggerRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/v1.adminPipelineTriggerResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/admin/projects/{id}/pipeline/status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.adminPipelineStatusResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/v1.renameProjectResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "syssettings.PublicSettings": {
            ...
            "properties": {
                "announcement_digest": {
                    "description": "AnnouncementDigest is nil when announcement_markdown is empty; otherwise it is lowercase sha256:\u003c64 lowercase hex\u003e.",
                    "type": "string",
                    "x-nullable": true,
                    "example": "sha256:315f5bdb76d078c43b8ac0064e4a0164612b1fce77c869345bfc94c75894edd3"
                },
        ...
        "v1.adminPipelineStatusResponse": {
            "type": "object",
            "properties": {
                "last_execution": {
                    "$ref": "#/definitions/handler.PipelineExecutionResponse"
        ...
        "v1.adminPipelineTriggerRequest": {
            "type": "object",
            "properties": {
                "clean_rebuild": {
                    "type": "boolean"
        ...
        "v1.adminPipelineTriggerResponse": {
            "type": "object",
            "properties": {
                "clean_rebuild": {
                    "type": "boolean"
